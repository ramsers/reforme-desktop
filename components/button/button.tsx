...
const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles =
        'group inline-flex items-center justify-center gap-2 font-semibold transition-colors focus:outline-none disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer'
